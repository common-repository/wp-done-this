...
/**
 * The Class / Function has been renamed for WP Standards
 * Camel Casing has been kept as this is an external library
 */

function wpdonethis_timeago($timestring, $timezone = NULL) {
  $timeAgo = new WP_Done_This_TimeAgo($timezone);
